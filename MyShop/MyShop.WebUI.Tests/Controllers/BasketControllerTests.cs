...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckOutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "juliusblusevicius20@gmail.com", ZipCode = "90210" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("juliusblusevicius20@gmail.com", "Forms"), null);
